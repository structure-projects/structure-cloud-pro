...
> **方案类型**: A+C混合精简版
> **适用场景**: 标准API文档生成、简单注解使用
> **升级条件**: 需要复杂安全配置、多分组管理时 → 切换B方案
...
> **B方案引用**: [structure-projects-rule.md](structure-projects-rule.md)
> **对应章节**: 第九章 - Swagger文档示例
> **详细内容包括**:
> - 安全Scheme配置（Bearer Token、API Key）
> - 多模块分组配置完整示例
> - 复杂响应注解使用
> - 认证流程说明
> - 接口版本管理
